...
import com.hotmasti.adapter.HomeSportAdapter;
...
import com.hotmasti.item.ItemSport;
...
public class SportDetailsActivity extends AppCompatActivity {
    ...
    WebView webView;
    TextView textTitle, textDate, textLanguage, textRelViewAll, textDuration, tvView;
    ...
    private void displayData() {
        ...
        if (itemSport.getSportView().isEmpty()) {
            ...
            tvView.setText(itemSport.getSportView());
        }
