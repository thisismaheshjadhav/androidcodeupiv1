...
import com.hotmasti.adapter.HomeTVAdapter;
...
import com.hotmasti.fragment.TVExoPlayerFragment;
...
public class TVDetailsActivity extends AppCompatActivity {
    ...
    WebView webView;
    TextView textTitle, textLanguage, textRelViewAll, tvView;
    ...
    private void displayData() {
        ...
        if (itemTV.getTvView().isEmpty()) {
            ...
            tvView.setText(itemTV.getTvView());
        }
